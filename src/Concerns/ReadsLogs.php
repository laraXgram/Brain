...
trait ReadsLogs
{
    ...
    /**
     * Resolve the current log file path based on LaraGram's logging configuration.
     */
    protected function resolveLogFilePath(?string $channel = null, ?string $default = null): string
    {
        ...
        $baseLogPath = Arr::get($channelConfig, 'path') ?? $default ?? storage_path('logs/laragram.log');
