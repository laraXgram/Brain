...
namespace LaraGram\Brain\Rules;
...
class RuleRepository
{
    ...
    protected const MANAGED_DIRNAME = 'brain';
    ...
    /**
     * Replace the Brain-managed rule files, keyed by filename slug, and regenerate the index.
     *
    ...
    /**
     * Remove all Brain-managed rule files. Returns whether the managed directory existed.
     */
