...
class GuidelineWriter
{
    ...
    public function write(string $guidelines): int
    {
        ...
        try {
            ...
            $pattern = '/<laragram-brain-guidelines>.*?<\/laragram-brain-guidelines>/s';
            $replacement = "<laragram-brain-guidelines>\n".$guidelines."\n\n</laragram-brain-guidelines>";
            $replaced = false;
            ...
            if (preg_match($pattern, $content)) {
                ...
                // No existing Brain guidelines found, append to end of existing file
                $frontMatter = '';
