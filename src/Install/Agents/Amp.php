...
class Amp extends Agent implements SupportsGuidelines, SupportsMcp, SupportsSkills
{
    ...
    {
        return config('brain.agents.amp.mcp_config_path', base_path('.amp/settings.json'));
    }
    ...
    {
        return config('brain.agents.amp.guidelines_path', 'AGENTS.md');
    }

    public function skillsPath(): string
    {
        return config('brain.agents.amp.skills_path', '.agents/skills');
    }
}
