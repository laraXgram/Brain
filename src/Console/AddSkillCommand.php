...
use LaraGram\Brain\Skills\Remote\AuditResult;
...
class AddSkillCommand extends Command
{
    ...
    /** @var string */
    protected $signature = 'brain:add-skill
    ...
    protected function displayHeader(): void
    {
        ...
        $this->displayBrainHeader('Skill', config('app.name'));
    }
    ...
    protected function runBrainUpdate(): void
    {
    ...
    {
        $this->displayOutro('Enjoy the brain 🚀', terminalWidth: $this->terminal->cols());
    }
}
