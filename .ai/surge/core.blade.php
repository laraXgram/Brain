...
- After changing code, the running server keeps the old code in memory: use `{{ $assist->commanderCommand('surge:start --watch') }}` in development and `{{ $assist->commanderCommand('surge:reload') }}` after deploying.
