...
## Generate Migrations with Commander

Use `php laragram make:migration` to generate the timestamped filename and migration structure.

```bash
php laragram make:migration create_posts_table
php laragram make:migration add_slug_to_posts_table
```
